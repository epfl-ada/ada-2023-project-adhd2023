...
•**Budget Dataset**:
This dataset contain metadata for all 45,000 movies listed in the Full MovieLens Dataset. we will use this data to only take the budget column and merge it on our data.  it is taken from [kaggle Oscars Dataset](https://www.kaggle.com/datasets/rounakbanik/the-movies-dataset?resource=download&select=movies_metadata.csv) 
.
## Methods
